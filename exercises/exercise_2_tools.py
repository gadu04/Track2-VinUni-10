...
LEGAL_KNOWLEDGE = [
    ...
    },
    {
        ...
        "text": (
            ...
            "Người sử dụng lao động phải trả bồi thường hợp đồng nếu chấm dứt trái pháp luật."
        ),
    },
]
...
def check_statute_of_limitations(case_type: str) -> str:
    ...
    limits = {
        ...
        "property": "5 năm",
        "labor": "3 năm (Bộ luật Lao động Việt Nam)",
    }
    return f"Thời hiệu khởi kiện cho {case_type}: {limits.get(case_type.lower(), 'Không xác định')}"
